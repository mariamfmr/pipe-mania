...
class Board:
    ...
    def is_connected_left(self, piece:str, row: int, col: int) -> bool:
        ...
        if col > 0:
            ...
            if piece == 'FE' and left_piece == 'FD':
                return False
            elif piece in ('FE', 'BC', 'BB', 'BE', 'VC', 'VE', 'LH'):
    ...
    def is_connected_right(self, piece:str, row: int, col: int) -> bool:
        ...
        if col < len(self.grid[0]) - 1:
            ...
            if piece == 'FD' and right_piece == 'FE':
                return False
            elif piece in ('FD', 'BC', 'BB', 'BD', 'VD', 'VB', 'LH'):
    ...
    def is_connected_upper(self, piece:str, row: int, col: int) -> bool:
        ...
        if row > 0:
            ...
            if piece == 'FC' and upper_piece == 'FB':
                return False
            elif piece in ('FC', 'BC', 'BE', 'BD', 'VC', 'VD', 'LV'):
    ...
    def is_connected_lower(self, piece:str, row: int, col: int) -> bool:
        ...
        if row < len(self.grid) - 1:
            ...
            if piece == 'FB' and lower_piece == 'FC':
                return False
            elif piece in ('FB', 'BB', 'BE', 'BD', 'VB', 'VE', 'LV'):
