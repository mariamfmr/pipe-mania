...
# Define allowed left neighbors for each piece
allowed_left_neighbors = {
    'FE': ['BC', 'BB', 'BE', 'VC', 'VE', 'LH'],
    'BC': ['FE', 'BC', 'BB', 'BD', 'VD', 'VB', 'LH'],
    'BB': ['FE', 'BC', 'BB', 'BD', 'VD', 'VB', 'LH'],
    'BE': ['FE', 'BC', 'BB', 'BD', 'VD', 'VB', 'LH'],
    'VC': ['FE', 'BC', 'BB', 'BD', 'VD', 'VB', 'LH'],
    'VE': ['FE', 'BC', 'BB', 'BD', 'VD', 'VB', 'LH'],
    'LH': ['FE', 'BC', 'BB', 'BD', 'VD', 'VB', 'LH']
}

# Define allowed right neighbors for each piece
allowed_right_neighbors = {
    'FD': ['BC', 'BB', 'BD', 'VD', 'VB', 'LH'],
    'BC': ['FD', 'BC', 'BB', 'BE', 'VC', 'VE', 'LH'],
    'BB': ['FD', 'BC', 'BB', 'BE', 'VC', 'VE', 'LH'],
    'BD': ['FD', 'BC', 'BB', 'BE', 'VC', 'VE', 'LH'],
    'VD': ['FD', 'BC', 'BB', 'BE', 'VC', 'VE', 'LH'],
    'VB': ['FD', 'BC', 'BB', 'BE', 'VC', 'VE', 'LH'],
    'LH': ['FD', 'BC', 'BB', 'BE', 'VC', 'VE', 'LH']
}
        
# Define allowed upper neighbors for each piece
allowed_upper_neighbors = {
    'FC': ['BB', 'BE', 'BD', 'VB', 'VE', 'LV'],
    'BC': ['FB', 'BB', 'BE', 'BD', 'VB', 'VE', 'LV'],
    'BE': ['FB', 'BB', 'BE', 'BD', 'VB', 'VE', 'LV'],
    'BD': ['FB', 'BB', 'BE', 'BD', 'VB', 'VE', 'LV'],
    'VC': ['FB', 'BB', 'BE', 'BD', 'VB', 'VE', 'LV'],
    'VD': ['FB', 'BB', 'BE', 'BD', 'VB', 'VE', 'LV'],
    'LV': ['FB', 'BB', 'BE', 'BD', 'VB', 'VE', 'LV']
}

# Define allowed lower neighbors for each piece
allowed_lower_neighbors = {
    'FB': ['FC', 'BC', 'BE', 'BD', 'VC', 'VD', 'LV'],
    'BB': ['FB', 'BC', 'BE', 'BD', 'VC', 'VD', 'LV'],
    'BE': ['FB', 'BC', 'BE', 'BD', 'VC', 'VD', 'LV'],
    'BD': ['FB', 'BC', 'BE', 'BD', 'VC', 'VD', 'LV'],
    'VB': ['FB', 'FD', 'FE', 'BB', 'VB', 'VE', 'LH'],
    'VE': ['FB', 'FD', 'FE', 'BB', 'VB', 'VE', 'LH'],
    'LV': ['FB', 'BB', 'BE', 'BD', 'VB', 'VE', 'LV']
}
...
class Board:
    ...
    def __init__(self, grid):
        ...
        self.explored_grid = [[' ' for _ in range(self.num_cols)] for _ in range(self.num_rows)]
...
class PipeMania(Problem):
    ...
    def bfs(self, state, source):
        ...
        if len(visited) != state.board.board_size:
            state.board.invalid = True
            return False
        return True
